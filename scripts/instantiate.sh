for org in 1 2; do
  ...
  peer chaincode instantiate -n evmcc -v $1 --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/example.com/tlsca/tlsca.example.com-cert.pem -C mychannel -c '{"Args":[]}'
  done
done
